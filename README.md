...
By *putting the crypto technology back on track*, we are creating a next-generation trustless blockchain platform, designed for rapid creation of metaverses, immersive user experiences and easy development of complex decentralized applications, which we called **SpaceXpanse Multiverse**, where people can communicate, develop, have fun and which can be easily accessed by anyone from anywhere.  
